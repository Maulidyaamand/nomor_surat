...
@section('content')
    ...
    <h4 style="margin-top:-10px; font-weight:bold; color: #A09F9F;">Surat Masuk PAS 2023</h4>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form action="/sumapas2023" method="POST">
      @csrf
...
<tbody>
  @foreach($suma_pas2023 as $smpas23)
  <tr>
      <td>{{ $smpas23->nomor_urut }}</td>
      <td>{{ $smpas23->nomor_surat }}</td>
      <td>{{ $smpas23->pengirim }}</td>
      <td>{{ $smpas23->tanggal }}</td>
      <td>{{ $smpas23->isi_ringkasan }}</td>
  </tr>
  @endforeach
</tbody>
</table>
