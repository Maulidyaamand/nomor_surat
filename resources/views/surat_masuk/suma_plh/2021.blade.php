...
@section('content')
    ...
    <h4 style="margin-top:-10px; font-weight:bold; color: #A09F9F;">Surat Masuk PLH/PLT 2021</h4>
...
<tbody>
  @foreach($suma_plh2021 as $smplh21)
  <tr>
    <td>{{ $smplh21->nomor_urut }}</td>
    <td>{{ $smplh21->nomor_surat }}</td>
    <td>{{ $smplh21->pengirim }}</td>
    <td>{{ $smplh21->tanggal }}</td>
    <td>{{ $smplh21->isi_ringkasan }}</td>
  </tr>
  @endforeach
</tbody>
</table>
