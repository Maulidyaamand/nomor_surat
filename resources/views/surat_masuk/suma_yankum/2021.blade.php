...
@section('content')
    ...
    <h4 style="margin-top:-10px; font-weight:bold; color: #A09F9F;">Surat Masuk Yankum 2021</h4>
...
<tbody>
  @foreach($suma_yankum2021 as $smy21)
  <tr>
    <td>{{ $smy21->nomor_urut }}</td>
    <td>{{ $smy21->nomor_surat }}</td>
    <td>{{ $smy21->pengirim }}</td>
    <td>{{ $smy21->tanggal }}</td>
    <td>{{ $smy21->isi_ringkasan }}</td>
  </tr>
  @endforeach
</tbody>
</table>
