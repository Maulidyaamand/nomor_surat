...
@section('content')
    ...
    <h4 style="margin-top:-10px; font-weight:bold; color: #A09F9F;">Surat Masuk Yankum 2023</h4>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form action="/sumayankum2023" method="POST">
      @csrf
...
<tbody>
  @foreach($suma_yankum2023 as $smy23)
  <tr>
      <td>{{ $smy23->nomor_urut }}</td>
      <td>{{ $smy23->nomor_surat }}</td>
      <td>{{ $smy23->pengirim }}</td>
      <td>{{ $smy23->tanggal }}</td>
      <td>{{ $smy23->isi_ringkasan }}</td>
  </tr>
  @endforeach
</tbody>
</table>
